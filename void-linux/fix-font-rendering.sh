...
genxresources  () {
    echo "Xft.autohint: 1" >> ~/.Xresources
    ...
    echo "Xresources created e configured"
}
...
'
export FREETYPE_PROPERTIES="truetype:interpreter-version=38" >> /etc/profile.d/freetype2.sh
